...
struct CardView: View {
    ...
    var dataset : HonzapdaCafe
    @Binding var gotoDetailBool: Bool  // 상세 뷰 이동 여부를 표시
    var body: some View {
        
        ZStack {
            // background img
            Image("Background_CardView")
                .resizable()
                .scaledToFill()
                .frame(width: 321, height: 441)
        ...
        //                                   height: UIScreen.main.bounds.height * 0.23) // 최외곽 VStack의 너비에 맞춤
        //                            .clipped() // VStack의 경계를 넘어가는 부분을 잘라냄
        //                            .onTapGesture {
        //                                self.gotoDetailBool = true
        //                              //  self.detailShopId = shopID
